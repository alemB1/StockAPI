...
namespace StockAPI.Controllers
{
    ...
    public class PortfolioController:ControllerBase
    {
        ...
        public async Task<IActionResult> AddPortfolio(string symbol)
        {
            ...
            if (userPortfolio.Any(e => e.Symbol.ToLower() == symbol.ToLower())) return BadRequest("stock exists,cant addsame stock to portfolio");
        ...
        public async Task<IActionResult> DeletePortfolio(string symbol)
        {
            ...
            var filteredStock = userPortfolio.Where(s => s.Symbol.ToLower() == symbol.ToLower()).ToList(); // filter the stock
